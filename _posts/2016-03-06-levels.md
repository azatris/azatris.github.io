...
The core idea of the theory is that there are 5 developmental levels where you are categorized into. The levels are mutually exclusive, but you aren't strictly pigeonholed into a particular level and usually in a transition from one to another.
...
And finally, the mythical level 5. It seems to me that anyone who has a foundation in probability theory and has brought it into life must necessarily be at level 5. The aspects of this level: e.g. seeing the possible limits of your own meaning making system, understanding that identity is only in the brain (and any particular identity you might hold might not be best aligned with your true values), you can hold a paradox in your brain without malfunctioning (seeing that as merely your [map, not the territory](https://en.wikipedia.org/wiki/Map%E2%80%93territory_relation)), and being generally humble about being possibly wrong are quite normal for anyone familiar with probability and logic. Recognizing commonalities is sort of a statistical inevitability. I am not sure what is meant by _interdependence with others_, but by the sound of it, it's obvious in a society we all depend on each other. Of course it is wonderful if that is also mutually acknowledged in relationships, possibly making it resembling a symbiosis.

So that wasn't so hard, was it? I am not mid-aged.
...
I got nothing out of this theory in the form of knowledge in order to make better life decisions that are aligned to my values.
