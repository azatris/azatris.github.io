...
This is also the biggest peeve with the theory that the categories don't seem really that difficult to achieve for reasonably smart people, even before mid-age (I don't really see how age makes a difference here). But I am open to considering [projection bias](https://en.wikipedia.org/wiki/Projection_bias) being in effect here, thinking that everyone can reason themselves through the levels. Maybe it _is_ really hard.
