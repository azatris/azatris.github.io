...
This is also the biggest peeve with the theory that the categories don't seem really that difficult to achieve for reasonably smart people. But I am open to considering [projection bias](https://en.wikipedia.org/wiki/Projection_bias) being in effect here.
